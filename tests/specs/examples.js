...
describe.skip('fdh/specs/examples', function () {
  ...
  describe('old large test cases that dont test anything in particular', function () {

    // *shrug* this test doesnt play well with code coverage. not super important.
    it('should not reduce SECTION to empty', function () {
      let dsl = `
        : '_ROOT_BRANCH_' = [1,1]
        : 'SECTION' = [1,1]
        'SECTION' >= 1                    # [1,1] >= 1
